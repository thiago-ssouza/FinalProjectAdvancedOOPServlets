  ...
  <jsp:include page="header.jsp"/>
      ...
      <div class="container register-form">
        ...
        <form method="post" action="${pageContext.request.contextPath}/user">
          <div class="form-row">
            <c:set var="servletParam" value="searchDelete" /> <!-- Set the value of the variable 'servletParam' -->
            <input type="hidden" name="servletParam" id="paramDeleteSearch" value="${servletParam}" />
            <div class="col-md-2 mb-3">
              <label for="usernameDeleteSearch">Username to Search</label>
            </div>
            <div class="col-md-2 mb-2">
              <input type="text" class="form-control" id="usernameDeleteSearch" name="usernameDeleteSearch" value="" placeholder="Username To Search" required>
            </div>
            <div class="col-md-1 mb-1">
              <input class="btn btn-primary" type="submit" id="submitDeleteSearch" value="Search User"/>
            </div>
          </div>
        </form>
      <form action="${pageContext.request.getContextPath()}/user" method="post">
        ...
        <c:set var="servletParam" value="delete" /> <!-- Set the value of the variable 'servletParam' -->
